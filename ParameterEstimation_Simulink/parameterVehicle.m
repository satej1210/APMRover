...
rNominal = 0.12; % [m] Nominal Wheel Radius
...
rr = 0.99*rNominal; %% Effective vehicle right wheel 
rl = rNominal; %%  1%% Effective vehicle left wheel to represent inaccuracy in the vehicle
